...
<body>
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="layout-page" style="margin-left: 16.25rem">
                    ...
                    <table class="table table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">electr population</th>
                            <th scope="col">electr Industry</th>
                          </tr>
                        </thead>
                        <tbody>
                            @foreach ($data as $key=>$d)
                                <tr>
                                    ...
                                    <td>{{findDistrict($d->district_code)}}</td>
                                    <td>{{$d->electr_population_volume}}</td>
                                    <td>{{$d->electr_industry_volume}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
